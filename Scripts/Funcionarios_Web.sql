DROP TABLE FUNCIONARIOS_WEB CASCADE CONSTRAINTS;
...
ALTER TABLE FUNCIONARIOS_WEB ADD(CONSTRAINT Func_PK PRIMARY KEY(CHAVE))
/
alter index FuncWeb_PK rebuild tablespace GESTAO_IDX;
---------------------------------------------------------------------------------------------
